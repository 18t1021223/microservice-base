...
import org.example.api.response.v1.ErrorRes;
...
//        SpringDocUtils.getConfig().replaceWithClass(ZoneId.class,String.class);
    ...
    public GroupedOpenApi apiUser() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("com.example.notificationservice.controller.v1")
                .addOpenApiCustomiser(globalOpenApiCustomer())
                .build();
    }

    @Bean
    public GroupedOpenApi apiUserV2() {
        return GroupedOpenApi.builder()
                .group("Notification V2")
                .addOperationCustomizer(new OperationNotesResourcesReader())
                .packagesToScan("com.example.notificationservice.controller.v2")
                .addOpenApiCustomiser(globalOpenApiCustomer())
                .build();
    }
    ...
    public io.swagger.v3.oas.models.info.Info info() {
        return new io.swagger.v3.oas.models.info.Info().title("Notification API")
